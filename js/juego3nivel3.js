...
// Pantalla de instrucciones
  ...
  function mostrarResultados() {
    ...
    try {
      addLevelCompletion('juego3', 'nivel-dificil', '', levelScore);
    } catch (e) { }
    try {
    ...
    window.location.href = '../../vistas/resultados.html?game=juego3&level=nivel3&score=' + levelScore + '&aciertos=' + aciertos;
  }
