...
// Pantalla de instrucciones
  function showInstrucciones() {
    ...
    card.innerHTML = `
            <h2 style="margin-bottom: 1rem;">Completa el Significado</h2>
            <p >Ahora la rueda no muestra todo.<br><br>
              La palabra aparece incompleta.<br>
              Falta una parte clave.<br><br>
              Las imágenes te ayudarán,<br>
              pero solo una encaja con la palabra correcta.<br><br>
              Completa el significado antes de que la rueda vuelva a girar.</p>
